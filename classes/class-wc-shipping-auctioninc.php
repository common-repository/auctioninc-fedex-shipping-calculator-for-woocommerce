 ...
 * WC_FedEx_Shipping_AuctionInc class.
...
class WC_FedEx_Shipping_AuctionInc extends WC_Shipping_Method {
    ...
    public function __construct() {
        ...
        $this->method_title = __('FedEx', 'wc_auctioninc');

        $this->method_description = __('<strong>AuctionInc\'s FedEx</strong> extension obtains rates dynamically from the AuctionInc API during cart/checkout.', 'wc_auctioninc');
    ...
    public function calculate_shipping( $package=array() ) {
        ...
        if ($this->account_id) {
            ...
            if (!empty($package['destination']['country'])) {
                ...
                $shipAPI->setHeaderRefCode('woo-fedex');

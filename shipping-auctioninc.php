<?php
/*
  Plugin Name: FedEx Shipping for WooCommerce
  Plugin URI: http://www.auctioninc.com/info/page/carrier_plugins
  Description: Accurate real-time shipping rates from FedEx. Free two week trial. No FedEx account required.
  Version: 1.3
  Author: Paid, Inc.
...
function wc_auctioninc_plugin_links($links) {
    ...
    $plugin_links = array(
        '<a href="' . admin_url('admin.php?page=wc-settings&tab=shipping&section=wc_fedex_shipping_auctioninc') . '">' . __('Settings', 'wc_auctioninc') . '</a>',
...
if (is_woocommerce_active()) {
    ...
    function wc_auctioninc_add_method($methods) {
        $methods[] = 'WC_FedEx_Shipping_AuctionInc';
        return $methods;
    }
        ...
        woocommerce_wp_multi_select(
                array(
                    ...
                    'options' => array(
                        ...
                        'SignatureReq' => __('Signature Required Charge', 'wc_auctioninc'),
                        'FDXAdultSignature' => __('Adult Signature Required Charge', 'wc_auctioninc'),
                        'FDXDirectSignature' => __('(Direct) Signature Required  Charge', 'wc_auctioninc'),
